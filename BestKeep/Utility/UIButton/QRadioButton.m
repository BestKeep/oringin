...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"unselect_image.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"select_image.png"] forState:UIControlStateSelected];
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    return CGRectMake(Q_RADIO_ICON_WH + Q_ICON_TITLE_MARGIN, (CGRectGetHeight(contentRect) - Q_RADIO_ICON_WH-5)/2.0,
