...
- (id)arrowImage
{
    if (!_arrowImage) {
        ...
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:_label.text]];
        //UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:MJRefreshSrcName(label.text)]];//@"arrow.png"
        arrowImage.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        arrowImage.backgroundColor = [UIColor yellowColor];
        [self addSubview:_arrowImage = arrowImage];
        
        
        self.label = [[UILabel alloc] initWithFrame:CGRectMake(0, -20, 20, 20)];
        self.label.center = arrowImage.center;
        ...
        self.label.textColor = COLOR_04;
        self.label.font = iconfont;
        self.label.text = @"\U0000e61a";
        [arrowImage addSubview: _label];
 ...
 *  状态标签
 */
- (UILabel *)activityView
{
    if (!_activityView) {
        //        UIActivityIndicatorView *activityView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        //        activityView.bounds = self.label.bounds;
        ...
        UIFont *iconfont = [UIFont fontWithName:@"iconFont" size: 20];
        label.textColor =COLOR_04;
        label.font = iconfont;
        label.text = @"\U0000e60a";
        [self addSubview:_activityView = label];
    }
