...
//    this.root="http://117.79.239.194:8080/nhshop";
    ...
    this.productDetailPage=this.root+"/static/shopperDetail.html";
...
var views={
    "tBody": {
        ...
        onComplete: function (ele,context) {   //视图加入文档后所执行的回调函数
            ...
            urlStr=url.banner+ctrl.currrentId+"?offset="+(ctrl.currentPageIndex-1)*ctrl.pageMaxSize+"&max="+ctrl.pageMaxSize;
...
/**测试*/
//$(function(data){
//    OBJC.executeJs("init",{backText:"新品",titleText:"初语",id:"402888d84df5edd1014df6470a00006c",userId:"402888874cdae817014cdb0cb50f0048"});
//});
